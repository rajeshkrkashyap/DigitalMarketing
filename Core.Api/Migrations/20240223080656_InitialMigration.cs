        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BalanceToken = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ApplicationServiceId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RechargeAmount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recharges_ApplicationServices_ApplicationServiceId",
                        column: x => x.ApplicationServiceId,
                        principalTable: "ApplicationServices",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Recharges_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Crawleds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Crawleds_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KeywordFrequency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    InternalLinks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExternalLinks = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    URLStructure = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentAnalysiss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContentAnalysiss_Crawleds_CrawledId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "076B9864-AEA6-4745-8016-B84ABE8B800C", "6221e499-46e5-4f80-94d7-85d4df357e51", "admin", "ADMIN" },
                    { "975B70A6-6C6A-4C02-9570-42F9B15B4D74", "c6525168-13b0-4735-9d4a-aedd547bb674", "student", "STUDENT" },
                    { "CCAFEA64-3A85-49AA-BA4B-7D2E296226FA", "48129C52-C42A-4C55-8448-5B1947403635", "patient", "PATIENT" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { "BEC293FA-B1E2-4B33-8FCC-375D83BF6246", "Educational Service", "product1.jpg", 5000L, "Connect To Ai" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentAnalysiss_CrawledId",
                table: "ContentAnalysiss",
                column: "CrawledId");

            migrationBuilder.CreateIndex(
                name: "IX_Crawleds_ProjectId",
                table: "Crawleds",
                column: "ProjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recharges_ApplicationServiceId",
                table: "Recharges",
                column: "ApplicationServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Recharges_AppUserId",
                table: "Recharges",
                column: "AppUserId");
        }
